...
#' @param shape.parameter Vector - Degree of skewness in the distribution. May be a single value, have a length equal to the number of levels of any one of the factors or a length equal to the product of the length of each factor.
...
twoway_simulation_correlated <- function(group_size, matrices_obj, distribution="normal", shape.parameter=0, inferior_limit= -Inf, superior_limit=Inf, balanced=TRUE, loss=NULL, nsims=200)
{
  ...
  if((distribution=="normal" | distribution=="truncated.normal") & (shape.parameter!=0))
  {
