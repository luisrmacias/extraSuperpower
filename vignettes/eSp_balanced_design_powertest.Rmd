...
{
  install.packages("extraSuperpower", upgrade = "never")
} 
...
We will use a low number of iterations for these examples. The default value for `nsims` is 150.

```{r}
set.seed(170824)
n <- seq(6, 12, 3)
indepmeasures_normal_sim <- simulate_twoway_nrange(matrices_obj = interaction_twoway,
                                            nset = n, distribution = "normal", nsims = 10)
