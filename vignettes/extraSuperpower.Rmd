...
To end this section, we will switch from an independent measurements design to a design were treatment is a between factor, while "Time" is a within factor, that is, the same study participant has been measures over the different levels of factor "Time". All other parameters will stay as in the independent measures interaction example.
